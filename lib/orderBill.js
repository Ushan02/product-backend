...
const STORE_NAME = process.env.STORE_NAME || "TechCart";
const STORE_EMAIL = process.env.STORE_EMAIL || process.env.SMTP_FROM || "ushansanuka2023@gmail.com";
const STORE_PHONE = process.env.STORE_PHONE || "0714780482";
const STORE_ADDRESS =
